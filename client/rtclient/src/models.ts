...
export interface GenericInputAudioDataMessage extends ClientMessageBase{
  bytes: string;
}

export interface GenericInputTextDataMessage extends ClientMessageBase{
  text: string;
}
...
export interface ControlMessage extends ServerMessageBase {
  type: "control";
  action: string;
  greeting?: string;
  id?: string;
...
export interface TextDeltaMessage extends ServerMessageBase {
  type: "text_delta";
  delta: string;
  id: string;
}

export interface AudioDeltaMessage extends ServerMessageBase {
  type: "audio_delta";
  delta: string;
  id: string;
}

export interface TranscriptionMessage extends ServerMessageBase {
  type: "transcription";
  text: string;
  id: string;
}

export interface UserMessage extends ServerMessageBase {
  type: "user_message";
  text: string;
  id: string;
}
...
export type UserMessageType =
  ...
  | GenericInputAudioDataMessage
  | GenericInputTextDataMessage;
